            ...
            <Box sx={{ display: "flex", justifyContent: "center", my: 2 }}>
              {[1, 2, 3, 4, 5].map((rating) => (
                <Button
                  key={rating}
                  variant={
                    currentQuestion.userRating === rating
                      ? "contained"
                      : "outlined"
                  }
                  onClick={() =>
                  ...
                  sx={{
                    mx: 0.5, // Margin to separate the buttons
                    height: "50px", // Set the height of the buttons
                    width: "50px", // Set the width of the buttons
                    fontSize: "1rem", // Set the font size
                    fontWeight: "bold", // Make the text bolder
                    padding: "10px 16px", // Adjust padding for better text display
                    textTransform: "none", // Prevent uppercase transform if needed
                  }}
                >
                  {rating}
                </Button>
